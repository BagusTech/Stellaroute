...
router.get('/', function(req, res, next){
	res.render('index', {
		title: 'Qandira: helping you explore your worls your way',
		description: 'Qandira, founded in 2015, is the world\'s formost innovator in travel technologies and services.'
	});
});

router.get('/review', function(req, res, next){
	res.render('review', {
		title: 'Write a Review - Qandira',
		description: 'Write a review to be used in Qandira. These reviews will be used to help users all over the world get a better sense of what places they may want to go to based on what people with similar preferences think.'
	});
});
